...
| Unit tests | 76 passed across 13 files | Tenant boundaries, safe responses, adapter, invitations, jobs, cron, receipts, package review gate, admin ownership/cancellation/key rotation, enrollment, branding URLs, schedule validation, draft onboarding and activation prerequisites; database/provider mocked |
