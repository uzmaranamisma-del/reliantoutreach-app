...
2. Paste that client's **isolated Manyreach clientspace API key** in the password field. The app discovers its ID with `/account`; organization/workspace-wide keys and clientspaces already assigned elsewhere are rejected.
